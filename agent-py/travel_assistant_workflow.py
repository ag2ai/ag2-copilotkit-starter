...
@wf.register(name="simple_learning", description="A travel agent assistant")
def travel_agent_assistant(ui: UI, params: dict[str, Any]) -> str:
    ...
    with llm_config:
        travel_agent = ConversableAgent(
            ...
            """,
            functions=[lookup_member, create_itinerary],
        )
